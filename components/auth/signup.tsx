            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-1 items-center justify-center p-4 sm:p-8">
                    <div className="w-full max-w-md space-y-6">
                        ...
                        <p className="text-gray-600">Join NMSEPrep to start your medical exam preparation journey.</p>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">

                                <label htmlFor="fullName" className='flex flex-col gap-1'>
                                    <span>Full Name</span>
                                    <input name="fullName" type='text' required onChange={
                        ...
                        <div className="text-center text-gray-600">
                            Already have an account? <Link href="/auth/signin" className="text-blue-800 font-medium hover:underline">Login</Link>
                        </div>
