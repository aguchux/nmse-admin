    ...
    <>
      ...
      <div className="space-y-6 text-center">
        ...
        <p className="max-w-lg text-base text-gray-100 lg:text-lg mx-auto">
          Access high-quality medical practice questions and detailed
          explanations to excel in your exams.
        </p>
      </div>
      <div className="text-center">
        <p className="text-sm text-teal-100">
          &rdquo;MedExamPro helped me pass my board exams on my first
          try!&rdquo; - Dr. Jane Doe
        </p>
      </div>
    </>
  );
