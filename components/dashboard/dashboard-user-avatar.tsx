  ...
  return (
    <div className="relative z-[100]">
      <button
        ...
        className={`flex items-center space-x-2 md:pl-1 md:pr-2 rounded-full md:py-1 shadow-md border border-gray-200 ${dropdownOpen ? 'bg-white' : 'bg-gray-50'}`}
      >
      ...
      {dropdownOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2">
          <Link
            href="/profile"
            className="px-4 py-2 text-gray-800 hover:bg-gray-200 w-full flex flex-row justify-start items-center gap-2"
          >
