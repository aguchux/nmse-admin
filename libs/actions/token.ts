...
const firebasePublicKeysUrl = process.env
  .NEXT_PUBLIC_FIREBASE_PUBLIC_KEYS_URL as string; // Ensure this is set in your env variables!
...
export const verifyToken = async (
  ...
  const verified = await jwtVerify(token, key, {
    issuer: `${process.env.NEXT_PUBLIC_SECURE_TOKEN_URL as string}/${firebaseProjectId}`,
